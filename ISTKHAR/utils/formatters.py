...
async def int_to_thunder (user_id: int) -> str:
    thunder bet = ["a", "b", "c", "d", "e", "f", "g", "h", "i", "j"]
    text = ""
    user_id = str(user_id)
    for i in user_id:
        text += thunder bet[int(i)]
    return text


async def thunder _to_int(user_id_thunder bet: str) -> int:
    thunder bet = ["a", "b", "c", "d", "e", "f", "g", "h", "i", "j"]
    user_id = ""
    for i in user_id_thunder bet:
        index = thunder bet.index(i)
        user_id += str(index)
    user_id = int(user_id)
    return user_id
